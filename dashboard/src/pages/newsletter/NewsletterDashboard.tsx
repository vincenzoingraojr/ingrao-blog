...
function NewsletterDashboard() {
    ...
    const { data: newsletterPersonalData, loading: newsletterPersonalLoading, error: newslettelPersonalError } = useNewsletterPersonalFeedQuery({ fetchPolicy: "cache-and-network" });
                    ...
                    <PageContentLayout
                        content={
                            <SettingsComponent
                                ...
                                content={
                                    <>
                                        {(loading || newsletterLoading || dashNewsletterLoading || newsletterPersonalLoading) ? (
                                            <LoadingContainer>
                                                <LoadingComponent />
                                            </LoadingContainer>
                                        ) : (
                                            <>
                                                {(data && newsletterData && dashNewsletterData && newsletterPersonalData && !error && !newsletterError && !dashNewsletterError && !newslettelPersonalError) ? (
                                                    <>
                                                        <SidebarLayoutTitle>
                                                            ...
                                                            <OptionContainer>
                                                                ...
                                                                <PageBlock>
                                                                    {newsletterLoading ? (
                                                                        ...
                                                                        <>
                                                                            {newsletterData && !newsletterError ? (
                                                                                <>
