                                                ...
                                                <PostFormContainer>
                                                    <Formik
                                                        ...
                                                        onSubmit={async (values, { setErrors, setStatus }) => {
                                                            ...
                                                            if (response.data) {
                                                                if (response.data.editPublishedPost.status && response.data.editPublishedPost.status.length > 0) {
                                                                    setStatus(response.data.editPublishedPost.status);
                                                                } else if (
                                                                    response.data.editPublishedPost.errors && response.data.editPublishedPost.errors.length > 0
                                                                ) {
                                                                    setStatus(null);
                                                                    setErrors(
